                ...
                <div class="row">
                    ...
                    <div class="col-md-9 col-sm-12 col-xs-12 custom-bg">
                        <div class="text-black">
                            <h2 class="text-center mb-4">NHỮNG GIÁ TRỊ CỐT LỎI</h2>
                            <hr>
                            <div class="company-introduction">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="row">
                                            <div class="col-12 giatri">
                                                <div style="margin-left: 20px;">
                                                    <!-- Item 1 -->
                                                    <div class="row items-giatricotloi">
                                                        <img src="images/giatricotloi/CotLoi.png" alt="">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
