      ...
      return (
        ...
        (!(i("body").width() < t.minWidth) &&
          ((function (t, e) {
            (t.initialized = !0),
              0 ===
                i("#theia-sticky-sidebar-stylesheet-" + t.namespace).length &&
                i("head").append(
                  i(
                  ...
                  if (e.stickySidebar.is(":visible"))
                    if (i("body").width() < e.options.minWidth) d();
                      ...
                      if (e.options.disableOnResponsiveLayouts) {
                        var a = e.sidebar.outerWidth(
                          "none" == e.sidebar.css("float")
                        );
                      ...
                      if (
                        ...
                        var p,
                          ...
                          S =
                            e.stickySidebar.outerHeight() + b + l <
                            i(window).height();
                        p = S
                        ...
                        "fixed" == e.stickySidebar.css("position") &&
                          ...
                          "stick-to-bottom" == e.options.sidebarBehavior &&
                            (y = p - e.stickySidebar.outerHeight()),
                          (y =
                            k > 0
                              ? Math.min(y, g)
                              : Math.max(y, p - e.stickySidebar.outerHeight())),
                          (y = Math.max(y, u)),
                          (y = Math.min(y, m - e.stickySidebar.outerHeight()));
                        var v =
                          e.container.height() == e.stickySidebar.outerHeight();
                        c =
                          (v || y != g) &&
                          (v || y != p - e.stickySidebar.outerHeight())
                            ? r + y - e.sidebar.offset().top - e.paddingTop <=
