                ...
                ?>
                    ...
                    <div class="item">
                        <div class="twm-jobs-grid-style2">
                            ...
                            <div class="twm-mid-content">
                                <a href="<?php echo 'viec-lam-ky-su-va-thong-dich-nhat-ban/' . $value['slug'] ?>/<?php echo $value['id_job'] ?>" class="twm-job-title">
                          ...
                          font-size: 13px;font-weight: 500;line-height: 16px;padding: 4px 8px;">
                            ...
                            <div class="twm-right-content">
                                ...
                                <a href="<?php echo 'viec-lam-ky-su-va-thong-dich-nhat-ban/' . $value['slug'] ?>/<?php echo $value['id_job'] ?>" class="twm-jobs-browse site-text-primary"><?= __('Chi tiết') ?></a>
                            </div>
                        </div>
                    </div>
