                ...
                <div class="panel-group" id="accordion">
                    ...
                    <div id="gioithieucongty" class="panel-collapse collapse in">
                      <div class="panel-body">
                        <ul>
                          ...
                          <li>
                            <a href="gioi-thieu/chi-nhanh-da-nang" target="_blank">Chi nhánh Đà Nẵng</a>
                          </li>
                          <li>
                            <a href="gioi-thieu/qua-trinh-phat-trien">Quá trình phát triển</a>
                          </li>
                          <li>
                            <a href="tuyen-ngon-Esuhai.html">Tuyên ngôn Esuhai</a>
                          </li>
                          <li>
                            <a href="loi-chao-tu-tong-Giam-Doc.html">Lời chào từ Tổng Giám đốc</a>
                          </li>
                        </ul>
                      </div>
                    </div>
                  ...
                  <div class="panel panel-default ">
                    <div class="panel-heading">
                      <h4 class="panel-title">
                        <a data-toggle="collapse" data-parent="#accordion" href="#gioithieubophan">
                          <span class="collapse_large">GIỚI THIỆU CÁC BỘ PHẬN</span><br>
                          <span class="collapse_small">Chuyên nghiệp + tinh thần cống hiến</span>
                        </a>
                      </h4>
                    </div>
                    <div id="gioithieubophan" class="panel-collapse collapse ">
                      <div class="panel-body">
                        <ul>
                          <li>
                            <a href="gioi-thieu-bo-phan/dao-tao-va-giao-duc">Đào tạo & giáo dục</a>
                          </li>
                          <li>
                            <a href="gioi-thieu-bo-phan/phai-cu-thuc-tap-sinh-ky-thuat">Phái cử thực tập
                              sinh kỹ thuật</a>
                          </li>
                          <li>
                            <a href="gioi-thieu-bo-phan/dao-tao & gioi-thieu-ky-su ">Đào tạo & giới thiệu kỹ sư</a>
                          </li>
                          <li>
                            <a href="gioi-thieu-bo-phan/gioi-thieu-viec-lam-trong-nuoc">Giới thiệu việc
                              làm trong nước</a>
                          </li>
                          <li>
                            <a href="gioi-thieu-bo-phan/tu-van-dau-tu">Tư vấn đầu tư</a>
                          </li>
                        </ul>
                      </div>
                    </div>
                    ...
                    <div class="panel-heading">
                      <h4 class="panel-title">
                        <a href="">
                          ...
                          <span class="collapse_small">Thông tin hoạt động Esuhai</span>
                        </a>
                      </h4>
                    </div>
                  </div>
                    ...
                    <div class="panel-heading">
                      <h4 class="panel-title">
                        <a href="#">
                          ...
                          <span class="collapse_small">Cập nhật Văn hóa - Kinh tế Nhật Bản</span>
                        </a>
                      </h4>
                    </div>
                  </div>
                    ...
                    <div class="panel-heading">
                      <h4 class="panel-title">
                        <a href="#">
                          ...
                          <span class="collapse_small">Chuyên mục thông tin nổi bật</span>
                        </a>
                      </h4>
                    </div>
                  </div>
                    ...
                    <div class="panel-heading">
                      <h4 class="panel-title">
                        <a href="#">
                          ...
                          <span class="collapse_small">Đối ứng dịch bệnh Covid-19</span>
                        </a>
                      </h4>
                    </div>
                  </div>
                  <div class="panel panel-default ">
                    <div class="panel-heading">
                      <h4 class="panel-title">
                        <a data-toggle="collapse" data-parent="#accordion" href="#thuvienmedia">
                          ...
                          <span class="collapse_small">Hệ thống nhận diện thương hiệu</span>
                        </a>
                      </h4>
                    </div>
                    <div id="thuvienmedia" class="panel-collapse collapse ">
                      <div class="panel-body">
                        <ul>
                          <li>
                            <a href="thu-vien-media/mang-xa-hoi-thuong-hieu">Mạng xã hội - Thương hiệu</a>
                          </li>
                          <li>
                            <a href="thu-vien-media/bao-chi-khen-thuong">Báo chí - Khen thưởng</a>
                          </li>
                        </ul>
                      </div>
                    </div>
                      ...
                      <h4 class="panel-title">
                        <a href="#" target="_blank">
                          <span class="collapse_large">BẢN TIN KAIZEN <span class="hidden-sm">SỐ
                              121</span></span>
                          <span class="collapse_small">Kinh nghiệm sống tại Nhật Bản</span>
                        </a>
                      </h4>
                    </div>
                  </div>
                    ...
                    <div class="panel-heading">
                      <h4 class="panel-title">
                        <a href="#" target="_blank">
                          ...
                          <span class="collapse_small">Cơ hội việc làm tại Nhật cho sinh viên</span>
                        </a>
                      </h4>
                    </div>
                  </div>
                    ...
                    <div class="panel-heading">
                      <h4 class="panel-title">
                        <a href="#">
                          ...
                          <span class="collapse_small">Chia sẻ - kinh nghiệm đậu JLPT</span>
                        </a>
                      </h4>
                    </div>
                  </div>
                  <div class="panel panel-default ">
                    <div class="panel-heading">
                      <h4 class="panel-title">
                        <a href="#" target="_blank">
                          <span class="collapse_large">TUYỂN DỤNG NHÂN VIÊN USUHAI</span><br><br>
                          <span class="collapse_small">Cùng gia nhập đại gia đình Esuhai</span>
                        </a>
                      </h4>
                    </div>
                  </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  ...
                  <div class="right_container_cont">
                    ...
                    <div class="right_container_cont_cont right_container_cont_cont_red">
                      <div class="right_container_cont_cont_ct">
                        <div class="right_container_cont_cont_row margin_bottom">
                    ...
                    <div class="right_container_cont_cont_1">
                      ...
                      <div class="right_container_cont_cont_cont">
                        <ul>
                          <li>+ Đào tạo, phái cử thực tập sinh, kỹ sư sang Nhật làm việc</li>
                          <li>+ Du học Nhật Bản</li>
                          <li>+ Giới thiệu việc làm trong nước</li>
                          <li>+ Tư vấn cho doanh nghiệp Nhật Bản đầu tư vào Việt Nam</li>
                        </ul>
                      </div>
                    </div>
                    <div class="right_container_cont_cont_1">
