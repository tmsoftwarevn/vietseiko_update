...
if ($conn->query($sql_vn_1) === TRUE) {
    echo "update thành công sql_vn1<br>";
} else {
...
if ($conn->query($sql_vn_2) === TRUE) {
    echo "update thành công sql_vn_2<br>";
} else {
...
if ($conn->query($sql_xkld_1) === TRUE) {
    echo "update thành công sql_xkld1<br>";
} else {
...
if ($conn->query($sql_xkld_2) === TRUE) {
    echo "update thành công sql_xkld_2<br>";
} else {
    echo "Error updating records for query 2: " . $conn->error;
}
//ksnb
...
if ($conn->query($sql_ksnb_1) === TRUE) {
    echo "update thành công sql_ksnb_1<br>";
} else {
...
if ($conn->query($sql_ksnb_2) === TRUE) {
    echo "update thành công sql_ksnb_2<br>";
} else {
    echo "Error updating records for query 2: " . $conn->error;
}
//vietseiko
...
if ($conn->query($sql_vsk_1) === TRUE) {
    echo "update thành công sql_vsk_1<br>";
} else {
...
if ($conn->query($sql_vsk_2) === TRUE) {
    echo "update thành công sql_vsk_2<br>";
} else {
    echo "Error updating records for query 2: " . $conn->error;
}
