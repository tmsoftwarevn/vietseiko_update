                ...
                <div class="row" style="transform: none">
                    <div class="col-lg-8 col-md-12">
                        <div class="masonry-wrap row d-flex" style="position: relative; height: 1699.97px">
                            <!--Block one-->
                            <?php
                            $list_of_allBanTin = Ban_tin::getAllBan_tin(); // Lấy tất cả các bản tin từ cơ sở dữ liệu
                            foreach ($list_of_allBanTin as $index => $post) {
                                ?>
                                <div class="masonry-item col-lg-6 col-md-12 m-b30"
                                    style="position: absolute; left: <?php echo ($index % 2) * 390; ?>px; top: <?php echo (floor($index / 2) * 566.656); ?>px">
                        ...
                        <div class="pagination-outer">
                            <div class="pagination-style1">
                                <ul class="clearfix">
                                    ...
                                    $totalItems = count($list_of_allBanTin); // Tổng số bài viết
                                            ...
                                            <div class="widget-post clearfix">
                                                ...
                                                <div class="wt-post-info">
                                                    <div class="wt-post-header">
                                                        ...
                                                        <span class="post-title">
                                                            <a href="blog-single.html">Advanced Service Functions by Air
                                                                Transport</a>
                                                        </span>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="widget-post clearfix">
                                                ...
                                                <div class="wt-post-info">
                                                    <div class="wt-post-header">
                                                        ...
                                                        <span class="post-title">
                                                            <a href="blog-single.html">Proper arrangement for keeping
                                                                the goods in
                                                                the warehouse</a>
                                                        </span>
                                                    </div>
