          ...
          <div class="table-responsive">
            <table class="table display mb-4 dataTablesCard job-table table-responsive-xl card-table" id="example5">
              ...
              <tbody>
                ...
                ?>
                  <tr>
                    <td><?php echo $value['id_nganhnghe'] ?></td>
                    <td><?php echo $value['name_nganhnghe'] ?></td>
                    
                    <td>
                      <div class="action-buttons d-flex justify-content-end">

                        <a href="job_nb_update.php?typeUpdate=nb&id=<?php echo $value['id_nganhnghe'] ?>" class="btn btn-secondary light mr-2">
                        ...
                        <a onclick="return confirm('Xác nhận muốn xóa Ngành nghề có Mã: <?php echo $value['id_nganhnghe']; ?>?')" href="job-vietnam/delete_jobNb.php?id_job=<?php echo $value['id_nganhnghe']; ?>"  class="btn btn-danger light">
                          <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="svg-main-icon">
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                              <rect x="0" y="0" width="24" height="24"></rect>
