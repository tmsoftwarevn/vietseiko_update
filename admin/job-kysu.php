        ...
        <div class="table-responsive">
          <table class="table display mb-4 dataTablesCard job-table table-responsive-xl card-table" id="example5">
            ...
            <tbody>
              ...
              $page = 1;
              $resultsPerPage = 8;
              $totalResults = count(Job_KySu::getAllJob_KySuNB());
              if (isset($_GET['page']) == TRUE) {
                $page = $_GET['page'];
              }
              $list_of_job = Job_KySu::getAllJobKysu_andCreatePagination($page, $resultsPerPage);
              ...
              ?>
                <tr>
                  <td><?php echo $value['id_kysu'] ?></td>
                  <td><?php echo $value['name_kysu'] ?></td>
                  <td><?php $nganhngheName = $jobNBAdmin->getNganhngheNB($value['id_nganhnghe_NB']);
                      foreach ($nganhngheName as $name => $num) echo $num['name_nn_NB'] ?></td>
                  <td class="wspace-no"><?php echo $value['ngaydang'] ?></td>
                  <td><?php echo $value['mucluong'] ?></td>
                  <td><?php echo $value['ngaychot'] ?></td>
                  <td>
                    <div class="action-buttons d-flex justify-content-end">
                      ...
                      <a onclick="return confirm('Are you want to delete?')" href="delete_job.php?id=<?php echo $value['id_NB']; ?>" class="btn btn-danger light">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="svg-main-icon">
                          <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                            <rect x="0" y="0" width="24" height="24"></rect>
