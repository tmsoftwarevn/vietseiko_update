            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="table-responsive">
                        <table id="ungtuyen" class="table display table-striped mb-4 ">
                            <thead>
                                <tr>
                                    <th>Stt</th>
                                    <th>Mã job</th>
                            ...
                            <tbody>
                                <?php
                                $page = 1;
                                $totalResults = count(Apply::getAll_cv(1, $startDate, $endDate));
                                if (isset($_GET['page']) == TRUE) {
                                    $page = $_GET['page'];
                                }

                                $list_of_apply = Apply::getAll_CV_andCreatePagination($page, $resultsPerPage, 1, $startDate, $endDate);
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="job_view.php?typeView=job&id=<?php echo $value['id_job'] ?>">
                                                ...
                                                <?php
                                                $get_jobcode = Job::get_jobcode($value['id_job']);
                        ...
                        <div class="d-flex align-items-center justify-content-sm-between justify-content-center flex-wrap">
                            ...
                            <nav aria-label="Page navigation example">
                                <ul class="pagination my-2 my-md-0">
                                    <?php echo Apply::paginate("cv-vn-list.php?per=$resultsPerPage&startDate=$startDate&endDate=$endDate&", $page, $totalResults, $resultsPerPage, 1) ?>
                                </ul>
                            </nav>
                        </div>
                    </div>
