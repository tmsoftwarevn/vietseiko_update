    ...
    <div class="content-body">
        ...
        <div class="container-fluid">
            <div class="d-flex align-items-center mb-4 flex-wrap">
                <h3 class="me-auto">Thông tin ứng viên Việt Nam</h3>
                    ...
                    <div class="table-responsive">
                        <table id="jobsTable" class="table display table-striped mb-4 dataTablesCard job-table table-responsive-xl card-table" id="example5">
                            ...
                            <tbody>
                                ...
                                $page = 1;
                                $resultsPerPage = 10;
                                $totalResults = count(Apply::getAll_cv());
                                if (isset($_GET['page']) == TRUE) {
                                    $page = $_GET['page'];
                                }

                                $list_of_apply = Apply::getAll_CV_andCreatePagination($page, $resultsPerPage);
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td onclick="openPdfInNewTab(<?php echo $value['link_cv'] ?>)"><?php echo $value['link_cv'] ?></td>
                                        <td><?php echo $value['created_at'] ?></td>
                                    </tr>
                                <?php } ?>
                            </tbody>
                        </table>
                        <p onclick="openPdfInNewTab('1703262352v4.0 Deploy React_Nodejs.pdf')">ttttttttttt</p>
                        ...
                        <div class="d-flex align-items-center justify-content-sm-between justify-content-center flex-wrap">
                            ...
                            <nav aria-label="Page navigation example">
                                <ul class="pagination my-2 my-md-0">
                                    <?php echo Apply::paginate("job-list.php?", $page, $totalResults, $resultsPerPage, 1) ?>
                                </ul>
                            </nav>
                        </div>
                    </div>
