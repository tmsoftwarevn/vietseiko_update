  ...
  <div class="content-body">
    ...
    <div class="container-fluid">
      <div class="d-flex align-items-center mb-4 flex-wrap">
        <h3 class="me-auto">Việc làm tại VietSeiko</h3>
        <div>
          <a href="job_add.php?typeAdd=job-vietseiko" class="btn btn-primary me-3 btn-sm"><i class="fas fa-plus me-2"></i>Thêm công việc mới</a>
        </div>
      </div>
          ...
          <div class="table-responsive">
            <table id="jobsTable" class="table display table-striped mb-4 dataTablesCard job-table table-responsive-xl card-table" id="example5">
              ...
              <tbody>
                ...
                $page = 1;
                //$resultsPerPage = 1;
                $totalResults = count(Vietseiko::getAllJob());
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="action-buttons d-flex justify-content-end">
                        ...
                        <a class="btn btn-success light mr-2 " href="job_vietseiko_view.php?typeView=job-vietseiko&id=<?php echo $value['id_job'] ?>">
                        ...
                        <a href="job_vietseiko_update.php?typeUpdate=vietseiko&id=<?php echo $value['id_job'] ?>" class="btn btn-secondary light mr-2">
            ...
            <div class="d-flex align-items-center justify-content-sm-between justify-content-center flex-wrap">
              ...
              <nav aria-label="Page navigation example">
                <ul class="pagination my-2 my-md-0">
                  <?php echo Vietseiko::paginate("job_vietseiko_list.php?per=$resultsPerPage&", $page, $totalResults, $resultsPerPage, 1) ?>
                </ul>
              </nav>
            </div>
          </div>
