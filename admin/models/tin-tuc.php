...
class Tin_tuc extends Db
{
    ...
    {
        $sql = self::$connection->prepare("INSERT INTO `blog`( `img_blog`, `tieude_blog`, `noidung_blog`, `type_id`,`slug`) 
    ...
    {
        $sql = self::$connection->prepare("UPDATE `blog` SET `img_blog`='$img_blog',`tieude_blog`='$name',`noidung_blog`='$noidung',`type_id`='$type',`slug`='$slug_custom' where id_blog = $id_blog");
