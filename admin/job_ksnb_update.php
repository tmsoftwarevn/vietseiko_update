...
$job_modal =  $job->getJob_KySu_ByID($id);
...
<body>
    ...
    <div class="content-body">
        <?php
        if (isset($_GET['typeUpdate']) == TRUE && $_GET['typeUpdate'] == "ksnb") {
        ?>
 <div style="padding:30px 0;text-align:center;font-weight:bold;font-size:15px;">
            ...
            <div class="body-view-job" style="padding: 0 100px 50px 100px">
                ...
                <div class="title-job" style="text-align: center; font-weight: 600; 
                    ...
                    <?php echo 'Cập nhật mã thông tin kỹ sư & thông dịch tại Nhật Bản: ' . $job_modal['job_code'] ?>
                </div>
                <form action="job-vietnam/form-ksnb-update.php" method="POST" enctype="multipart/form-data">
