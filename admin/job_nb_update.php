...
$job_modal =  $job_nb->getJobNB_ByID_admin($id);
...
<body>
    ...
    <div class="content-body">
        ...
        <?php
        if (isset($_GET['typeUpdate']) == TRUE && $_GET['typeUpdate'] == "job-nb") {
        ?>
            ...
            <div class="body-view-job" style="padding: 100px;">
                ...
                font-size: 20px; text-transform: capitalize;">
                    <?php echo 'Cập nhật mã công việc XKLD Nhật Bản: ' . $job_modal['id_job'] ?>
                </div>
                <!-- job-vietnam/form-update.php -->
                <form action="job-vietnam/form_nb-update.php" method="POST" enctype="multipart/form-data">
