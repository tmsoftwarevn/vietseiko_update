          ...
          <div class="col-xl-12">
            <div class="card" id="user-activity1">
              ...
              <div class="card-body">
                ...
                <span class="fs-16 font-w600 me-5">239
                  <small class="text-success fs-12 font-w400">+0.4%</small></span>
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="71" height="71" viewBox="0 0 71 71">
                          <g transform="translate(-457 -443)">
                            ...
                            <g transform="translate(457 443)">
                              ...
                              <circle data-name="Ellipse 11" cx="11" cy="11" r="11" transform="translate(36 15)" fill="#ffe70c" style="
              ...
              <div class="card-body loadmore-content dlab-scroll height370 recent-activity-wrapper" id="RecentActivityContent">
                ...
                <div class="d-flex recent-activity">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ms-3">
                      <h5 class="mb-1">
                        Elextra Studios has invited you to interview
                        meeting tomorrow
                      </h5>
                      <span>8min ago</span>
                    </div>
                ...
                <div class="d-flex recent-activity">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ms-3">
                      <h5 class="mb-1">
                        Highspeed Design Team have 2 available positions
                        for you
                      </h5>
                      <span>8min ago</span>
                    </div>
                  ...
                  <div class="items">
                    <div class="jobs">
                      ...
                      <div class="text-center">
                        ...
                        <span><i class="fas fa-comments-dollar me-2"></i>$
                          2,000 - $ 2,500</span>
                      </div>
                    </div>
                  </div>
