...
<div class="page-content" style="transform: none">
            ...
            <div class="wt-bnr-inr-entry">
                ...
                <div>
                    <ul class="wt-breadcrumb breadcrumb-style-2">
                        <li><a href="viec-lam-xkld-nhat-ban"><?= __('Xuất khẩu lao động Nhật Bản') ?></a></li>
    ...
    ?>
    <!-- OUR BLOG START -->
    <div class="section-full p-t30 p-30 bg-white" style="transform: none">
                ...
                ?>
                    ...
                    <div class="item">
                        <div class="twm-jobs-grid-style2">
                            ...
                            <div class="twm-mid-content">
                            <a href="<?php echo 'viec-lam-xkld-nhat-ban/' . $value['slug'] ?>/<?php echo $value['id_job'] ?>" class="twm-job-title">
                          ...
                          font-size: 13px;font-weight: 500;line-height: 16px;padding: 4px 8px;">
                            ...
                            <div class="twm-right-content">
                                ...
                                <a href="<?php echo 'viec-lam-xkld-nhat-ban/' . $value['slug'] ?>/<?php echo $value['id_job'] ?>" class="twm-jobs-browse site-text-primary"><?= __('Chi tiết') ?></a>
                            </div>
                        </div>
                    </div>
